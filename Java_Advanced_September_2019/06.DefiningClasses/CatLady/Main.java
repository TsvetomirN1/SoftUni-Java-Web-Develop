    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!"End".equals(input = reader.readLine())) {
            ...
            if (breed.equals("StreetExtraordinaire")) {
                catMap.put(data[1], new StreetExtraordinaire(data[1],
                        data[0], Double.parseDouble(data[2])));
            } else if (breed.equals("Siamese")) {
                catMap.put(data[1], new Siamese(data[0], data[1],
                        Double.parseDouble(data[2])));
            } else {
                catMap.put(data[1], new Cymric(data[1], data[0],
                        Double.parseDouble(data[2])));
            }
        }
